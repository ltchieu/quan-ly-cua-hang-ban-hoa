  ...
  <div class="row justify-content-center">
    <div class="col-lg-6">
      <div class="card shadow-lg">
        <div class="card-header" style="background: linear-gradient(135deg, #1434cb 0%, #1e88e5 100%); color: white;">
        ...
        <div class="card-body text-center py-5">
          ...
          <div class="alert alert-info mb-4">
            ...
            <p class="mb-0"><strong>Số tiền:</strong> <span
                style="color: #1434cb; font-weight: bold; font-size: 1.1rem;">{{ number_format($total, 0, '.', ',') }}
                ₫</span></p>
          </div>
          ...
          <div class="text-start mb-4">
            ...
            <ol class="small text-muted">
              <li>Mở ứng dụng ngân hàng hoặc ví điện tử hỗ trợ VNPAY-QR.</li>
          ...
          <div class="mb-4 pb-3 border-bottom">
            ...
            <a href="{{ $payUrl }}" target="_blank" class="btn btn-primary btn-sm">
        ...
        <div class="card-footer bg-light text-center text-muted small">
          <i class="bi bi-shield-check me-1"></i>Giao dịch được bảo mật bởi VNPay
        </div>
      </div>
    </div>
  </div>
